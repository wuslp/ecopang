...
<body class="ecopang_main">
	<div id="page" class="page">
		...
		<div class="eventWriteContent">
			<form action="adminEventWritePro.jsp" name="inputForm" method="post" enctype="multipart/form-data" onsubmit="return check()">
					...
					<tr>
						<td>
							<%if (dto.getEve_img() != null) {// 사진저장된게 있을경우%> 
								<img src="/ecopang/imgs/<%=dto.getEve_img()%>" id="previewImg"  width="150" />
							<%} else {%> 
					...
					<tr>
						<td class="eventWriteBtn" colspan="2">
							<input type="submit" value="저장" class="btn"/>
                     		<input type="button" value="취소" class="btn" onclick="window.location='adminEventInfo.jsp'">						
						</td>
					</tr>
				</table>
			</form>
