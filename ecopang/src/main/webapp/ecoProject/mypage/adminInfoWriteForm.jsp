...
<body class="ecopang_main">
	<div id="page" class="page">
		<header id="header" class="site-header cf">
			<div class="header-wrap">
				...
				<nav class="nav">
					<ul class="menubar">
						<li><a class="active"
							href="/ecopang/ecoProject/main/main.jsp">메인</a></li>
		...
		<div>
			<form action="adminInfoWritePro.jsp" method="post" name="inputForm" onsubmit="return check()">
				<table>
					<tr>
						<td>제목</td>
					</tr>
					<tr>
						<td><textarea rows="1" cols="40" name="info_title"></textarea>
						</td>
					</tr>
					<tr>
						<td><textarea rows="10" cols="40" name="info_content"></textarea>
						</td>
					</tr>
					<tr>
						<td><input type="submit" value="작성" /> <input type="button"
							value="취소" onclick="window.location='adminEventInfo.jsp'" /></td>
					</tr>
				</table>
			</form>
		</div>
