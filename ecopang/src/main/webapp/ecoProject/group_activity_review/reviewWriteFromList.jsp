...
<script type="text/javascript">
	...
	function cancel(){
		  ...
		  var user_img = document.getElementById("rev_img");
...
<div id="topic" class="site-content">
	...
	<div class="main">
		<div class="rev">
			<form action="reviewWriteFromListPro.jsp" method="post" name="inputForm" onsubmit="return check()" enctype="multipart/form-data">
			<%--12P 와 수정 필요 --%>
			...
			<div class="rwf">
				<table class="rwf1">
					...
					<tr>
						...
						<input type="file" name="rev_img" id="rev_img" onchange="preview(this)"/></td>
					</tr>	
					<tr>
						<td class="rwf-b1"><input type="button" value="삭제" onclick="cancel()"/></td>
					</tr>
				</table>
				...
				<table>	
					...
					<tr>
						<td><textarea name="rev_content" rows="20" cols="50"></textarea></td>
					</tr>
					<tr>
						<td class="rwf-b2"><input type="submit" value="작성">&nbsp;&nbsp;<input type="button" value="취소" onclick="window.location='reviewAll.jsp?group_num=<%=group_num %>'"/></td>
					</tr>
				</table>
			</form>
		</div>
