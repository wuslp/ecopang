...
<body class="ecopang_main">
	<div id="page" class="page">
		...
		<div class="eventWriteContent">
			<form action="eventModifyPro.jsp" name="inputForm" method="post" enctype="multipart/form-data" onsubmit="return check()">
...
<script>
<!--
	$('#summernote').val('<%=dto.getEve_content()%>');
	//var url = '/ecopang/ecoProject/imgs/';
	//var filename = '야쿠르트.jpg';
