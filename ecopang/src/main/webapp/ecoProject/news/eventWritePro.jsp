...
<jsp:useBean id="dto" class="ecopang.model.EventDTO"/>
...
<%
	...
	*/
	...
	String eve_img = mr.getFilesystemName("eve_img"); // 업로드해서 저장된 파일 이름
...
//	String[] type = contentType.split("/"); //컨텐트타입에 들어있는 값을 / 기준으로 나누어 결과를 배열에 담아준다
	...
	*/
	...
	dao.insertEvent(dto); //eventInsert메서드 실행 dto객체 넣어줌!
